...
CMD="$CMD parm $WEST_SIM_ROOT/reference/2kod_4f_leap.pdb [nmrparm] \n"
CMD="$CMD reference $WEST_SIM_ROOT/reference/2kod_4f_leap.pdb parm [nmrparm] name [nmr] \n"
CMD="$CMD parm $WEST_SIM_ROOT/reference/1a43_4f_leap.pdb [xtalparm] \n"
CMD="$CMD reference $WEST_SIM_ROOT/reference/1a43_4f_leap.pdb parm [xtalparm] name [xtal] \n"
CMD="$CMD parm $WEST_SIM_ROOT/reference/hex_4f_leap.pdb [hexparm] \n"
CMD="$CMD reference $WEST_SIM_ROOT/reference/hex_4f_leap.pdb parm [hexparm] name [hex] \n"
CMD="$CMD parm $WEST_SIM_ROOT/reference/pent_4f_leap.pdb [pentparm] \n"
CMD="$CMD reference $WEST_SIM_ROOT/reference/pent_4f_leap.pdb parm [pentparm] name [pent] \n"
CMD="$CMD autoimage \n"
...
# rmsd to reference
CMD="$CMD parm $WEST_SIM_ROOT/reference/d2-4f.pdb [d2parm] \n"
CMD="$CMD reference $WEST_SIM_ROOT/reference/d2-4f.pdb parm [d2parm] name [d2] \n"
# D2 ref rms calcs
...
# rmsd to reference
CMD="$CMD parm $WEST_SIM_ROOT/reference/1a8o_4f_leap.pdb [1a8oparm] \n"
CMD="$CMD reference $WEST_SIM_ROOT/reference/1a8o_4f_leap.pdb parm [1a8oparm] name [1a8o] \n"
# 1A8O ref rms calcs
...
paste <(cat oamin_pcoord.txt)> $WEST_PCOORD_RETURN
