...
binsperdim=[20]   # You will have prod(binsperdim)+numberofdim*(2+2*splitIsolated)+activetarget bins total

pcoordlength=101 # length of the pcoord

maxcap=[100]	#for each dimension enter the maximum number at which binning can occur, if you do not wish to have a cap use inf

mincap=[20]  #for each dimension enter the minimum number at which binning can occur, if you do not wish to have a cap use -inf
