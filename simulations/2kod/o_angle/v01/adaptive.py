...
binsperdim=[25]   # You will have prod(binsperdim)+numberofdim*(2+2*splitIsolated)+activetarget bins total
pcoordlength=101 # length of the pcoord
PCA=False       # choose to do principal component analysis
maxcap=[70]	#these are in the order of the dimensions left is first dimension and right is second dimension
mincap=[20]
