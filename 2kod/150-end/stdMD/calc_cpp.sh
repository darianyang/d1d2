...
trajin ../06_prod_dry.nc 1 last $INT
trajin ../07_prod_dry.nc 1 last $INT
trajin ../08_prod_dry.nc 1 last $INT
trajin ../09_prod_dry.nc 1 last $INT
trajin ../10_prod_dry.nc 1 last $INT

#parm ../${PDB}_solv.prmtop
