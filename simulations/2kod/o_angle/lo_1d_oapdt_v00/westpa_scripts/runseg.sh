...
CMD="$CMD reference /bgfs/lchong/dty7/hiv1_capsid/std/2kod/lo_pH/v00/2kod_lo_pH_solv.pdb :* name [nmr] \n"
CMD="$CMD reference /bgfs/lchong/dty7/hiv1_capsid/std/1a43/lo_pH/v00/1a43_lo_pH_solv.pdb :* name [xtal] \n"
...
# NMR ref rms calcs
CMD="$CMD rms Fit_M2_NMR :94-163@CA,C,O,N ref [nmr] \n"
CMD="$CMD rms RMS_M1_NMR :6-75@CA,C,O,N ref [nmr] nofit mass time 1 out rms_m1_nmr.dat \n"
CMD="$CMD rms RMS_H9M1_NMR :36-49@CA,C,O,N nofit ref [nmr] out rms_h9m1_nmr.dat mass time 1 \n"

CMD="$CMD rms Fit_M1_NMR :6-75@CA,C,O,N ref [nmr] \n"
CMD="$CMD rms RMS_M2_NMR :94-163@CA,C,O,N ref [nmr] nofit mass time 1 out rms_m2_nmr.dat \n"
CMD="$CMD rms RMS_H9M2_NMR :124-137@CA,C,O,N nofit ref [nmr] out rms_h9m2_nmr.dat mass time 1 \n"
...
# XTAL ref rms calcs
CMD="$CMD rms Fit_M2_XTAL :94-163@CA,C,O,N ref [xtal] \n"
CMD="$CMD rms RMS_M1_XTAL :6-75@CA,C,O,N ref [xtal] nofit mass time 1 out rms_m1_xtal.dat \n"
CMD="$CMD rms RMS_H9M1_XTAL :36-49@CA,C,O,N nofit ref [xtal] out rms_h9m1_xtal.dat mass time 1 \n"

CMD="$CMD rms Fit_M1_XTAL :6-75@CA,C,O,N ref [xtal] \n"
CMD="$CMD rms RMS_M2_XTAL :94-163@CA,C,O,N ref [xtal] nofit mass time 1 out rms_m2_xtal.dat \n"
CMD="$CMD rms RMS_H9M2_XTAL :124-137@CA,C,O,N nofit ref [xtal] out rms_h9m2_xtal.dat mass time 1 \n"
...
# HEX ref rms calcs
CMD="$CMD rms Fit_M2_HEX :94-163@CA,C,O,N ref [hex] \n"
CMD="$CMD rms RMS_M1_HEX :6-75@CA,C,O,N ref [hex] nofit mass time 1 out rms_m1_hex.dat \n"
CMD="$CMD rms RMS_H9M1_HEX :36-49@CA,C,O,N nofit ref [hex] out rms_h9m1_hex.dat mass time 1 \n"

CMD="$CMD rms Fit_M1_HEX :6-75@CA,C,O,N ref [hex] \n"
CMD="$CMD rms RMS_M2_HEX :94-163@CA,C,O,N ref [hex] nofit mass time 1 out rms_m2_hex.dat \n"
CMD="$CMD rms RMS_H9M2_HEX :124-137@CA,C,O,N nofit ref [hex] out rms_h9m2_hex.dat mass time 1 \n"
...
# PENT ref rms calcs
CMD="$CMD rms Fit_M2_PENT :94-163@CA,C,O,N ref [pent] \n"
CMD="$CMD rms RMS_M1_PENT :6-75@CA,C,O,N ref [pent] nofit mass time 1 out rms_m1_pent.dat \n"
CMD="$CMD rms RMS_H9M1_PENT :36-49@CA,C,O,N nofit ref [pent] out rms_h9m1_pent.dat mass time 1 \n"

CMD="$CMD rms Fit_M1_PENT :6-75@CA,C,O,N ref [pent] \n"
CMD="$CMD rms RMS_M2_PENT :94-163@CA,C,O,N ref [pent] nofit mass time 1 out rms_m2_pent.dat \n"
CMD="$CMD rms RMS_H9M2_PENT :124-137@CA,C,O,N nofit ref [pent] out rms_h9m2_pent.dat mass time 1 \n"
