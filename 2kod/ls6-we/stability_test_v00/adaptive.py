...
maxcap=[70, 70]	#these are in the order of the dimensions left is first dimension and right is second dimension
mincap=[0, 0]
targetstate=[None]    #enter boundaries for target state or None if there is no target state in that dimension
targetstatedirection=[0,0]  #if your target state is meant to be greater that the starting pcoor use 1 or else use -1
