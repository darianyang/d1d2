...
WEST=data/4F_d2d1_r02.h5

SCHEME="ANALYSIS/TEST" 
...
w_assign -W ../../$WEST --bins-from-file BINS --states-from-file STATES -o assign.h5 --construct-dataset module.pull_data_3d --serial &&
...
#w_direct kinetics -a assign.h5 -W ../../$WEST -o direct.h5 --evolution-mode cumulative --step-iter 1 &&
